...
def compare_data(graf, dataset, grad):
        ...
        print(str(day_1)+"."+str(month_1)+"."+str(year_1))
        print(str(day_2)+"."+str(month_2)+"."+str(year_2))
...
def compare_day(graf, dataset, years, months, days, grad):
        ...
        bar_graph(graf, title, yLabel, bar[0], bar[1], id=2)



        labels = [(i, dates[i-1]) for i in num]
        print(str(num))
        print(str(dates))
        print(str(labels))
        ax = graf.ui.Graf.getAxis('bottom')
...
def get_mjesec_data(graf, dataset, gradovi):
        ...
        line_graph(graf, title, xLabel, yLabel, xyRange, x, y, 1, gradovi)

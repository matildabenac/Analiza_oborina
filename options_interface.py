...
class Ui_OptionsWindow(object):
    ...
    def openDataWindow(self):
        ...
        if self.mjesecRadio.isChecked():
            ...
            # if numGradovi == 1:
            # elif numGradovi == 2:
            #     gt.mjesec_data(self, dataset_1, dataset_2, dataset_3, gradovi)
            # else:
            #     gt.mjesec_data(self, dataset_1, dataset_2, dataset_3, gradovi)
        ...
        if self.godinaRadio.isChecked():
            ...
            # if numGradovi == 1:
            #     gt.get_godina_data(self, dataset_1, gradovi)
            # elif numGradovi == 2:
            #     gt.get_godina_data_two(self, dataset_1, dataset_2, gradovi)
            # else:
